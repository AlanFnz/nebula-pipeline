...
EFFECTS = (
    ...
    Effect("particles", "Particle attractor", "Dots follow an invisible 3D target. Impulse gives short, peaked expansions with long holds; Surges adds uneven arrivals and rebound. Release chooses a floor band or outward orbit. Set Assembly cycle to 0 for manual Assembly.",
           ...
           looks=(("Human signal surges", {"particles.attractor": 3, "particles.motion": 1, "particles.release": 0, "particles.period": 5., "particles.collapse": .97}),
                  ...
                  ("Two impulses / 15s", {"particles.attractor": 3, "particles.motion": 2, "particles.release": 1, "particles.period": 7.5, "particles.phase": 0., "particles.expand_seconds": .75, "particles.gather_seconds": 1., "particles.motion_peak": .8, "particles.chaos": .35, "particles.orbit_speed": 24., "particles.dispersion": .9, "particles.scale": .8, "particles.released_brightness": .55, "particles.hue": .70, "particles.saturation": .42, "particles.color_spread": .09, "particles.color_drift": .001}),
