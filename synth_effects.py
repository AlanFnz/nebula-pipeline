...
EFFECTS = (
    ...
    Effect("particles", "Particle attractor", "Dots follow an invisible 3D target. Human head adds anatomical detail. Surges adds acceleration and uneven arrivals; Gentle preserves the first version. Set Assembly cycle to 0 for manual Assembly.",
           paths("particles"), ("particles",),
           looks=(("Human signal surges", {"particles.attractor": 3, "particles.motion": 1, "particles.period": 5., "particles.collapse": .97}),
                  ("Assemble / disperse", {}),
                  ("Held portrait", {"particles.breathing": 0., "particles.assembly": 1., "particles.rotation_speed": 0., "particles.turbulence": .06}),
                  ("Signal fountain", {"particles.collapse": .95, "particles.color_spread": 1.5, "particles.turbulence": .3}),
                  ("Orbiting ring", {"particles.attractor": 2, "particles.pitch": 35., "particles.xray": .4})), primary=8),
