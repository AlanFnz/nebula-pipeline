...
EFFECTS = (
    ...
    Effect("particles", "Particle attractor", "Dots follow an invisible 3D target. Surges adds acceleration and uneven arrivals. Release chooses a cloud / floor band or outward expansion with delayed vertical-axis orbit. Set Assembly cycle to 0 for manual Assembly.",
