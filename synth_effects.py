...
EFFECTS = (
    ...
    Effect("particles", "Particle attractor", "Persistent dots gather around an invisible 3D head, sphere or ring. Assembly cycle releases them automatically; set it to 0 for manual Assembly. Combine with bloom and grain.",
           paths("particles"), ("particles",),
           looks=(("Assemble / disperse", {}),
